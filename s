...
if screenSize.X < 1080 then  -- Mobile resolution (you can adjust the threshold as needed)
    base.Size = Settings.Size or UDim2.fromOffset(screenSize.X * 0.8, screenSize.Y * 0.8)
else
